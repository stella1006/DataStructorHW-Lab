...
class SERVICE{
public:
	explicit SERVICE():total_time_unit(0), serviced_customers_amount(0), que(),serviced_time(0)
	{
	...
	void print()
	{
		...
		cout<<"There are still "<<que.size()<<" customers in queue"<<endl;
